...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('incident_type', models.CharField(choices=[('SOUND', 'Loud Noise'), ('MOTION', 'Suspicious Motion'), ('THEFT', 'Theft'), ('VANDALISM', 'Vandalism'), ('OTHER', 'Other')], max_length=10)),
        ...
        migrations.AddField(
            model_name='evidence',
            name='incident',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='evidences', to='analysis.incidentreport'),
        ),
        migrations.CreateModel(
            name='Alert',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('incident', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='analysis.incidentreport')),
            ],
        ),
        migrations.CreateModel(
            name='SecurityDevice',
        ...
        migrations.AddField(
            ...
            name='device',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='analysis.securitydevice'),
        ),
    ]
